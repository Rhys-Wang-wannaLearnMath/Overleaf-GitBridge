...
import { Identity, Credentials } from './api';
...
export class SessionManager {
    ...
    private _lastCsrfRefresh = 0;
    private _onLog: (msg: string) => void;

    private static readonly CSRF_REFRESH_INTERVAL_MS = 10 * 60 * 1000; // 10 minutes

    constructor(identity: Identity, authStore: AuthStore, onLog?: (msg: string) => void) {
     ...
     */
    async captureCookies(resHeaders: { raw(): { [key: string]: string[] } }): Promise<void> {
