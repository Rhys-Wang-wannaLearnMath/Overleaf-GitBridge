...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('overleaf-gitbridge.startSync', async () => {
        ...
        const quietSeconds = getConfig('quietSeconds', 30);
        const pollSeconds = getConfig('pollSeconds', 2);
        syncEngine = new gitSync_1.GitSyncEngine(ws, quietSeconds, pollSeconds, {
