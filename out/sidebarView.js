...
class SidebarProvider {
    ...
    // ── State setters ──
    setCredentials(hasToken, hasCookie) {
        this.state.hasToken = hasToken;
        this.state.hasCookie = hasCookie;
        this._updateHtml();
    }
    setProject(isOverleaf, name) {
    ...
    setConflictInfo(files, diffSummary, localAhead, remoteBehind) {
        this.state.conflictFiles = files;
...
SidebarProvider.viewType = 'overleaf-gitbridge.sidebar';
